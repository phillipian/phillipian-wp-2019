        ...
        <div class='breaking-grid'>
            ...
            <div class='breaking-image'>
                ...
                <?php if (get_theme_mod('plip-breaking-youtube', '') != '') :
                    ...
                    <div class='breaking-article'>
                        <div class='yt-container'>
                            <iframe src='https://www.youtube.com/embed/<?php echo get_theme_mod('plip-breaking-youtube'); ?>?modestbranding=1'
                ...
                if (!$breakingcoverage) : ?>
                    ...
                    <p class='breaking-checkback'>Check back later and follow our social media for the latest
                        coverage.</p>
                ...
                <p>Do you have thoughts about these policy changes? Start writing, be it a 100-word or 1000-word
                    response, and email <a href='mailto:commentary@phillipian.net'>commentary@phillipian.net</a>.</p>
